...
export default class Tab extends Component {
  ...
  constructor(props: TabProps) {
    ...
    this.state = {
      fixed: {
        iconY: active ? new Animated.Value(0) : new Animated.Value(0),
        labelScale: active ? new Animated.Value(1) : new Animated.Value(1),
        labelY: active ? new Animated.Value(0) : new Animated.Value(0),
        iconOpacity: active ? new Animated.Value(1) : new Animated.Value(1)
      },
      shifting: {
